					...
					<div class="zone-field">
						<label for="zone">Zone
					        <select name="zone">
					          ...
					          <option value="Vash\'Jir">Vash\'Jir</option>
					          <option value="Le tréfond">Le tréfond</option>
					          <option value="Uldum">Uldum</option>
					          <option value="Les Hautes terres du crépuscule">Les Hautes terres du crépuscule</option>
					        </select>
						</label>
					</div>
				</div>
